    ...
    >
      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-12 relative z-10">
        <div className="w-full md:w-1/2 text-center md:text-left order-2 md:order-1">
          ...
          {/* একমাত্র ডাউনলোড বাটন */}
          <div className="mt-10 flex justify-center md:justify-start">
            <button
              onClick={handleDownload}
              className="bg-orange-500 hover:bg-orange-600 active:bg-orange-700 
                         text-white font-bold py-4 px-12 rounded-2xl text-lg 
                         shadow-xl transition-all active:scale-95 flex items-center gap-2 justify-center min-w-[280px]"
            >
              📲 এখনই ডাউনলোড করুন
            </button>
          </div>
