...
const MyMatch = () => {
   ...
   return (
     <div style={{ background: "#f3f4f6", minHeight: "100vh", maxWidth: 450, margin: "0 auto", paddingBottom: 100 }}>
       ...
       {/* ── Content Container (কার্ডগুলোকে দুই পাশে বড় করার জন্য প্যাডিং কমানো হয়েছে) ── */}
         ...
         {matches.map((m) => {
           ...
           return (
             <div key={m._id} style={{
               ...
               overflow: "hidden", 
               marginBottom: 16,   
               width: "100%",                            // নিশ্চিত করবে কার্ডটি যেন পুরো ফুল সাইজ নেয়
               paddingTop: 4,                          
             }}>
               ...
               <div style={{ display: "flex", gap: 14, padding: "16px 16px 12px" }}>
                 <img
                   ...
                   alt=""
                   style={{ 
                     width: 105,                        // ইমেজ সাইজ আরও বড় করা হয়েছে
                     height: 78,                        
                     borderRadius: 10, 
                     objectFit: "cover", 
                     flexShrink: 0 
               ...
               {/* ── Stats Grid (ভেতরের লেখার সাইজ ও গ্যাপ বড় করা হয়েছে) ── */}
               ...
               {/* ── Room + Prize Buttons (বাটনগুলো এখন আরও বড় ও ক্লিকেবল) ── */}
