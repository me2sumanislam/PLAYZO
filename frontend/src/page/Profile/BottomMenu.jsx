  ...
  return (
    <div className="bg-white min-h-screen pb-10">
      ...
      <div className="bg-gradient-to-b from-[#56CCF2] to-[#2F80ED] pt-12 pb-8 px-6 text-center text-white">
        <div className="w-20 h-20 bg-yellow-400 rounded-full mx-auto mb-3 border-4 border-white/30 flex items-center justify-center text-4xl shadow-inner">
          👨‍💻
        </div>
        ...
        <div className="grid grid-cols-3 mt-8 items-center border-t border-white/20 pt-4">
          <div className="text-center">
            ...
            <p className="text-[10px] font-bold uppercase opacity-90">ম্যাচ জয়েন</p>
          </div>
      ...
      <div className="mt-4 px-2 space-y-0.5">
        {menuItems.map((item) => (
          <button
            ...
            className="w-full flex items-center justify-between p-4 hover:bg-gray-50 border-b border-gray-50"
          >
      ...
      <div className="px-8 mt-12">
        <button
          onClick={onLogout}
          className="w-full bg-[#3B82F6] text-white py-3.5 rounded-full font-black uppercase tracking-widest text-xs shadow-lg shadow-blue-200"
        >
          Logout
        </button>
      </div>
